...
@section('content')
    <div class="container mx-auto mt-10">
        <!-- Section des 3 Produits Récents -->
            ...
            @foreach($recentProducts as $product)
                <div class="bg-white shadow-lg rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div class="p-4">
                        ...
                        <a href="{{ route('products.show', $product->id) }}" class="block text-center bg-gray-300 hover:bg-gray-400 text-black text-center py-2 rounded transition-all duration-300 ease-in-out">Voir Détails</a>
                    </div>
                </div>
            @endforeach
        </div>
